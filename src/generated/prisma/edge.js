...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\Freelance\\test\\iboss\\src\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://neondb_owner:npg_Z7DQfoOa9KhY@ep-billowing-sun-a4xar3uo-pooler.us-east-1.aws.neon.tech/neondb?sslmode=require"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../src/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nenum Role {\n  USER\n  ADMIN\n}\n\nmodel User {\n  id        String    @id @default(cuid())\n  name      String?\n  email     String    @unique\n  password  String\n  role      Role      @default(USER)\n  createdAt DateTime  @default(now())\n  updatedAt DateTime  @updatedAt\n  articles  Article[]\n}\n\nmodel Article {\n  id        String   @id @default(cuid())\n  title     String\n  content   String\n  published Boolean  @default(false)\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n  author    User     @relation(fields: [authorId], references: [id], onDelete: Cascade)\n  authorId  String\n}\n",
  "inlineSchemaHash": "b16fd9d88f4ebd35e484a9201696e864b0ff9f083cfb332cbe640185fdf98d2c",
  "copyEngine": true
}
config.dirname = '/'
